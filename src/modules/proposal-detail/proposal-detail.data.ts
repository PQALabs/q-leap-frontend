...
export const proposalDetail = {
  ...
  sections: [
    ...
    {
      heading: 'Specification & Methodology',
      paragraphs: ['Chaos Labs has not been compensated by any third party for publishing this recommendation.'],
    },
    {
      heading: 'Disclosure',
      paragraphs: [
  ...
  ] satisfies ProposalContentSection[],
  references: ['Implementation: ...', 'Tests: ...', 'Snapshot: Direct-to-AIP', 'Discussion'],
