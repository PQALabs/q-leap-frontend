...
describe('formatUserReserve', () => {
  ...
  it('should format a user reserve ', () => {
    ...
    expect(formattedReserve.underlyingBalanceMarketReferenceCurrency).toEqual('0.53756570959579768');
    expect(formattedReserve.underlyingBalanceUSD).toEqual('2456.5368266611907407457116696');
    expect(formattedReserve.totalBorrows).toEqual('52.314205');
    expect(formattedReserve.totalBorrowsMarketReferenceCurrency).toEqual('0.0115203841632001');
    expect(formattedReserve.totalBorrowsUSD).toEqual('52.645188204926088393345997');
    ...
    expect(formattedReserve.variableBorrowsMarketReferenceCurrency).toEqual('0.0115203841632001');
    expect(formattedReserve.variableBorrowsUSD).toEqual('52.645188204926088393345997');
  });
});
