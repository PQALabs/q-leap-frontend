import { calculateSupplies, type SuppliesRequest } from './calculate-supplies';
...
describe('calculateSupplies', () => {
  ...
  it('should calculate the correct supplies', () => {
    const { totalLiquidity, totalStableDebt, totalVariableDebt } = calculateSupplies(reserveSuppliesInput);
