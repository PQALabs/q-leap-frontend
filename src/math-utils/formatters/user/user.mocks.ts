import type { FormatUserSummaryRequest, RawUserReserveData } from './index';
...
export const userReservesEthMarket = [usdcUserReserveEthMarket, ethUserReserveEthMarket];

export const userReservesUsdMarket = [usdcUserReserveUsdMarket, avaxUserReserveUsdMarket];
