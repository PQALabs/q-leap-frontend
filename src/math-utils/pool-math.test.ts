...
describe('pool math', () => {
  ...
  it('should calculate compounded stable balances', () => {
    ...
    const compoundedStableBalance = getCompoundedStableBalance(compoundedStableBalanceRequest);
  ...
  it('should convert balances to MarketReferenceCurrency and USD', () => {
    ...
    expect(marketReferenceCurrencyBalance.toNumber()).toEqual(10 * 10 ** balanceRequest.marketRefCurrencyDecimals);
